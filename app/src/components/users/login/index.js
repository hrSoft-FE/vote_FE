...
import qqIcon from '../../../images/login/qq.png'
import weiboIcon from '../../../images/login/weibo.png'
import wechatIcon from '../../../images/login/wechat.png'
      ...
      <div className='login-wrapper'>
        ...
        <div className='login'>
          ...
          <div className='icon-wrapper'>
            <div className='icon-item'><img src={qqIcon} alt='' /></div>
            <div className='icon-item'><img src={weiboIcon} alt='' /></div>
            <div className='icon-item'><img src={wechatIcon} alt='' /></div>
          </div>
          <div className='line-through'>
            <div className='line-through-line'></div>
